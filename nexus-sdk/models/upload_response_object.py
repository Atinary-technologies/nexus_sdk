...
class UploadResponseObject(object):
    ...
    @property
    def id(self):
        """Gets the id of this UploadResponseObject.  # noqa: E501

        ID assigned to the file once it is uploaded  # noqa: E501

        :return: The id of this UploadResponseObject.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UploadResponseObject.

        ID assigned to the file once it is uploaded  # noqa: E501

        :param id: The id of this UploadResponseObject.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadResponseObject):
            return False
