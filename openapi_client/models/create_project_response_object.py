...
class CreateProjectResponseObject(object):
    ...
    def __init__(self, id=None, local_vars_configuration=None):  # noqa: E501
        """CreateProjectResponseObject - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CreateProjectResponseObject.  # noqa: E501

        ID assigned to the project once created in Web Portal  # noqa: E501

        :return: The id of this CreateProjectResponseObject.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreateProjectResponseObject.

        ID assigned to the project once created in Web Portal  # noqa: E501

        :param id: The id of this CreateProjectResponseObject.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateProjectResponseObject):
            return False
