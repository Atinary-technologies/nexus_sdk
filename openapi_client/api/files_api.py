...
class FilesApi(object):
    ...
    def list_files(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str project_id: **Required** ID assigned to the project once created in Web Portal.
    ...
    def upload_file(self, project_id, group_type, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str project_id: ID assigned to the project once created in Web Portal. (required)
    ...
    def upload_file_with_http_info(self, project_id, group_type, **kwargs):  # noqa: E501
        ...
        if 'inline_object' in local_var_params:
            # Code customized by cwilliamson@chemos.io.
