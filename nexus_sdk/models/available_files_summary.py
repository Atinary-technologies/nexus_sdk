...
class AvailableFilesSummary(object):
    ...
    def parameters(self, parameters):
        ...
        if (self.local_vars_configuration.client_side_validation and
                parameters is not None and parameters > 10000):  # noqa: E501
            raise ValueError("Invalid value for `parameters`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def properties(self, properties):
        ...
        if (self.local_vars_configuration.client_side_validation and
                properties is not None and properties > 10000):  # noqa: E501
            raise ValueError("Invalid value for `properties`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def other(self, other):
        ...
        if (self.local_vars_configuration.client_side_validation and
                other is not None and other > 10000):  # noqa: E501
            raise ValueError("Invalid value for `other`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
