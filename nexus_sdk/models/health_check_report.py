...
class HealthCheckReport(object):
    ...
    def generated_at(self):
        ...
        The ISO8601 date and time representing the start of the healthcheck report.  # noqa: E501
    ...
    def generated_at(self, generated_at):
        ...
        if (self.local_vars_configuration.client_side_validation and
                generated_at is not None and len(generated_at) > 26):
            raise ValueError("Invalid value for `generated_at`, length must be less than or equal to `26`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                generated_at is not None and len(generated_at) < 26):
            raise ValueError("Invalid value for `generated_at`, length must be greater than or equal to `26`")  # noqa: E501
