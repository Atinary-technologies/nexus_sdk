...
class ProjectDetail(object):
    ...
    def __init__(self, id=None, name=None, owner=None, members=None, files=None, group_id=None, description='', creation_date=None, local_vars_configuration=None):  # noqa: E501
    ...
    def members(self, members):
        ...
        if (self.local_vars_configuration.client_side_validation and
                members is not None and len(members) > 20):
            raise ValueError("Invalid value for `members`, number of items must be less than or equal to `20`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                members is not None and len(members) < 1):
    ...
    @property
    def group_id(self):
        """Gets the group_id of this ProjectDetail.  # noqa: E501

        Group identifier (group name in this case)  # noqa: E501

        :return: The group_id of this ProjectDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this ProjectDetail.

        Group identifier (group name in this case)  # noqa: E501

        :param group_id: The group_id of this ProjectDetail.  # noqa: E501
        :type group_id: str
        """
        if (self.local_vars_configuration.client_side_validation and
