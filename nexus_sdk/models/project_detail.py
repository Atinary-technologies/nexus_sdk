...
class ProjectDetail(object):
    ...
    def __init__(self, project_id=None, id=None, name=None, owner=None, members=None, files=None, description='', creation_date=None, local_vars_configuration=None):  # noqa: E501
