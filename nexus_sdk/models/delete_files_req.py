...
class DeleteFilesReq(object):
    ...
    def __init__(self, ids=None, local_vars_configuration=None):  # noqa: E501
        """DeleteFilesReq - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def ids(self):
        """Gets the ids of this DeleteFilesReq.  # noqa: E501

        A comma separated list of file_id to delete.  # noqa: E501

        :return: The ids of this DeleteFilesReq.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this DeleteFilesReq.

        A comma separated list of file_id to delete.  # noqa: E501

        :param ids: The ids of this DeleteFilesReq.  # noqa: E501
        :type ids: list[str]
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            raise ValueError("Invalid value for `ids`, number of items must be less than or equal to `500`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteFilesReq):
            return False
