...
class AvailableFile(object):
    ...
    @property
    def file_id(self):
        """Gets the file_id of this AvailableFile.  # noqa: E501

        ID assigned to the file once it is uploaded  # noqa: E501

        :return: The file_id of this AvailableFile.  # noqa: E501
        :rtype: str
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this AvailableFile.

        ID assigned to the file once it is uploaded  # noqa: E501

        :param file_id: The file_id of this AvailableFile.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AvailableFile):
            return False
