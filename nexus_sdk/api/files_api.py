...
class FilesApi(object):
    ...
    def delete_files(self, **kwargs):  # noqa: E501
        ...
        :param DeleteFilesReq delete_files_req:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def delete_files_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'delete_files_req' in local_var_params:
            ...
            if 'file' in local_var_params['delete_files_req'].to_dict(): # Added line
                local_var_files = local_var_params['delete_files_req'].to_dict() # Added line
            else: # Added line
    ...
    def upload_file(self, project_id, group_type, **kwargs):  # noqa: E501
        ...
        :param UploadFileReq upload_file_req:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upload_file_with_http_info(self, project_id, group_type, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'upload_file_req' in local_var_params:
            
            # Note: Customization required as the SDK generated didn't detected a file inside a multipart-form request body
            if 'file' in local_var_params['upload_file_req'].to_dict(): # Added line
                local_var_files = local_var_params['upload_file_req'].to_dict() # Added line
            else: # Added line
                body_params = local_var_params['upload_file_req']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
